...
## Tools Available:
- view_file, write_to_file, replace_file_content, multi_replace_file_content (for implementing refactoring changes)
- grep_search, find_by_name (for analyzing code patterns and finding similar code)
- read_url_content, browser_subagent (for researching refactoring patterns and best practices)
- run_command (for running tests and validation during refactoring)
