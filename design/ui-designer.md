...
## Tools Available:
- view_file, write_to_file, replace_file_content, multi_replace_file_content (for creating UI component code and specifications)
- grep_search, find_by_name (for analyzing existing UI patterns and components)
- read_url_content, browser_subagent (for researching design trends, patterns, and best practices)
- run_command (for generating UI scaffolding or running design tools)
