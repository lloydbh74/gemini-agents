...
## Tools Available:
- view_file, write_to_file, replace_file_content, multi_replace_file_content (for creating wireframe documentation and specifications)
- grep_search, find_by_name (for analyzing existing interface patterns)
- read_url_content, browser_subagent (for researching wireframing best practices and UX patterns)
- run_command (for generating wireframe templates or running prototyping tools)
