...
## Core Capabilities:
- write_to_file API documentation with code examples and integration guides
- Create user manuals and product documentation
- write_to_file system architecture and technical specification documents
- Create troubleshooting guides and FAQ sections
- write_to_file installation and setup instructions
- Create developer onboarding and getting started guides
- write_to_file process documentation and standard operating procedures
