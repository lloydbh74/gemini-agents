...
## Tools Available:
- view_file, write_to_file, replace_file_content, multi_replace_file_content (for creating API specifications and documentation)
- grep_search, find_by_name (for analyzing existing API code)
- read_url_content, browser_subagent (for researching API design patterns and standards)
- run_command (for testing API endpoints and generating documentation)
